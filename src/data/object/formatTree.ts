...
type formatType = (originItem: objectAny, type?: 'append' | 'init', mapItemData?: objectAny) => objectAny
 ...
 * @returns 树形数组
 */
function formatTree(originList: objectAny[], option: optionType = {}) {
  // 配置参数获取
